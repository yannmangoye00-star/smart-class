...
const stats = [
  { label: "Élèves suivis", value: "128", icon: Users },
  { label: "Moyenne générale", value: "14.2 / 20", icon: GraduationCap },
  { label: "Cours publiés", value: "42", icon: BookOpen },
  { label: "Tendance", value: "+18%", icon: BarChart3 },
];
